...
describe('JobHistory e2e test', () => {
  ...
  it('should create an instance of JobHistory', () => {
    ...
    cy.get(`[data-cy="startDate"]`).type('2021-10-09T22:41').should('have.value', '2021-10-09T22:41');

    cy.get(`[data-cy="endDate"]`).type('2021-10-09T12:49').should('have.value', '2021-10-09T12:49');
